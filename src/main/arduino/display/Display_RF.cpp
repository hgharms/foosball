...
void Display_RF::LcdCharacter(char character){
  LcdWrite(LCD_D, 0x00);
...
void Display_RF::LcdInitialise(void){
...
void Display_RF::LcdString(char *characters){
  while (*characters)
  {
...
void Display_RF::LcdWrite(byte dc, byte data){
...
void Display_RF::gotoXY(int x, int y){
